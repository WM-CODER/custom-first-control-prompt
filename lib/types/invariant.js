import { SEED_SOURCE, TRANSCRIPT_FRAME_CLOSE, TRANSCRIPT_FRAME_INTRO, TRANSCRIPT_FRAME_OPEN, TRANSCRIPT_RESERVED_TAGS, } from "./seed.js";
...
function validateSession(session, fail) {
    for (const event of session.events) {
        if (isSeededMessage(event))
            validateSeededMessage(event, fail);
    }
}
