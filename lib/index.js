import { a as TRANSCRIPT_RESERVED_TAGS, c as buildSeedEvents, d as seedTranscript, f as seededMessageSource, l as hasSeededHistory, o as appendSeedTurns, s as buildHistoryMessage, u as isSeededByPlugin } from "./seed-d3pQqMkk.js";
...
let PanelService = (() => {
	...
	return class PanelService extends _classSuper {
		...
		configClear(agent) {
			return this.writePatch(PanelService.buildPatch({
				found: true,
				sections: [],
				history: [],
				includeSubagents: false,
...
function apply(ctx, config) {
	...
	if ((config.seedMode ?? "hook") === "append") {
